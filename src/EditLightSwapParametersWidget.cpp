  ...
  d(new Private())
{
...

  {
    ...
    {
      l->addWidget(new QLabel("Diffuse"));
...
void EditLightSwapParametersWidget::setLightSwapParameters(const tp_math_utils::LightSwapParameters& lightSwapParameters)
{
  ...
  d->diffuseScaleEnabled.checkbox->setCheckState(lightSwapParameters.diffuseScaleEnabled ? Qt::Checked : Qt::Unchecked);

  d->diffuseScaleMin.set(lightSwapParameters.diffuseScaleMin);
  d->diffuseScaleMax.set(lightSwapParameters.diffuseScaleMax);
...
tp_math_utils::LightSwapParameters EditLightSwapParametersWidget::lightSwapParameters() const
{
  ...
  lightSwapParameters.diffuseScaleEnabled = d->diffuseScaleEnabled.get();
  lightSwapParameters.diffuseScaleMax     = d->diffuseScaleMax.get();
